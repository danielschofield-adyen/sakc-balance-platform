...
<script src="../frontend/setPostalCode.js"></script>
                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary text-warning">Select your Postal Code!</h6>

                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                <div class="form-check form-check-inline">
<input type="text" class="form-control" id="postal_value" style="width: 7em">
</div>
                                  ...
                                  <button id="btn-transfer" class="btn btn-primary btn-lg btn-block" onclick= "callSetPostalCode()">Submit</button>
